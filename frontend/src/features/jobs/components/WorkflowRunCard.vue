  ...
  <n-list-item>
    <n-thing :title="workflow.title" :description="workflow.input_name">
      ...
      <n-space vertical size="small">
        ...
        <n-flex v-for="step in workflow.steps" :key="step.sequence" align="center">
...
import { isFailedJobStatus, type JobStatus } from '@/features/jobs/api/jobs'
import type { WorkflowRun } from '@/features/jobs/api/workflows'
