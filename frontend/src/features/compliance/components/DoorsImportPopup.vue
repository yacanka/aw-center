  ...
  >
    <n-space vertical size="large">
      <n-alert type="info" :bordered="false">
        The module is read by the Windows DOORS worker. Data is validated with the same identity,
        required-field, project, version, and concurrency checks as Excel imports.
      </n-alert>
      ...
      <n-space>
        ...
        <n-text v-if="job" depth="3"> Worker job: {{ job.status }} · {{ job.progress }}% </n-text>
      </n-space>
