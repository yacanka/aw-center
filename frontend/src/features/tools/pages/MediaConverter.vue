  ...
  <n-space vertical size="large">
    <n-card title="Media Converter">
      ...
      <n-form label-placement="top" style="margin-top: 16px">
        ...
        <n-grid cols="1 640:2 1100:4" :x-gap="16" responsive="screen">
...
import MediaUploadDropzone from '@/shared/components/MediaUploadDropzone.vue'
...
import { previewMediaConversion, type MediaPreviewResult } from '@/features/tools/api/mediaTools'
import { createMediaJob } from '@/features/jobs/api/jobs'
...
@media (max-width: 640px) {
  .media-preview :deep(.n-descriptions-table) {
    display: block;
    overflow-x: auto;
  }
}
