...
import LoginTagline from '@/features/session/components/LoginTagline.vue'
...
<template>
  <main class="login-page">
    <header class="login-brand">AW Center<span class="brand-dot" aria-hidden="true"></span></header>
