...
async function sendPasswordResetRequest() {
  ...
  try {
    ...
    window.$message.success('Check your inbox and follow the instructions to set a new password.', {
      duration: 5000
    })
    ...
    forgotPasswordPopup.value.footerText =
      'Something went wrong while sending reset link to your email.'
  }
}
...
<template>
            ...
            >
              <n-grid :x-gap="12" :cols="6">
                ...
                <n-form-item-gi span="2">
                  <n-tag checkable @click="onForgotPassword"> Forgot Password? </n-tag>
                </n-form-item-gi>
              </n-grid>
            </n-form>
          </n-card>
          ...
          <n-card title="Signup" size="large">
            ...
            >
              <n-grid :x-gap="12" :cols="12">
                <n-form-item-gi span="6" label="Username" path="username">
                  <n-input
                    v-model:value="signupCredentials.username"
                    type="text"
                    placeholder="Enter your registration number"
                  />
                </n-form-item-gi>
                ...
                <n-form-item-gi span="6" label="Password" path="password2">
                  <n-input
                    v-model:value="signupCredentials.password2"
                    type="password"
                ...
                <n-form-item-gi span="4">
                  <n-button type="primary" attr-type="submit" @click="handleSignup"
                    >Signup</n-button
                  >
                </n-form-item-gi>
              </n-grid>
      ...
      <n-card title="Set new password" size="large">
        ...
        >
          <n-grid :x-gap="12" :cols="6">
            <n-form-item-gi span="6" label="Password" path="password">
              <n-input
                v-model:value="newPasswordRequest.password"
                type="password"
            ...
            <n-form-item-gi span="6" label="Confirm Password" path="passwordConfirm">
              <n-input
                v-model:value="newPasswordRequest.passwordConfirm"
                type="password"
            ...
            <n-form-item-gi span="6">
              <n-button type="primary" attr-type="submit" @click="handleUpdatePassword"
                >Update</n-button
              >
            </n-form-item-gi>
          </n-grid>
  ...
  <n-modal
    v-model:show="forgotPasswordPopup.visible"
    preset="card"
    ...
    >
      <n-grid :x-gap="12" :cols="12">
        <n-form-item-gi span="10" label="Email" path="email">
          <n-input
            v-model:value="forgotPasswordPopup.email"
            type="email"
            placeholder="Enter your email"
            :disabled="
              forgotPasswordPopup.status != 'default' && forgotPasswordPopup.status != 'error'
            "
          />
        </n-form-item-gi>
        <n-form-item-gi span="2">
