...
from integrations.teamcenter.client import TeamcenterClient
from integrations.teamcenter.config import AuthMode, TeamcenterClientConfig
from integrations.teamcenter.exceptions import TeamcenterConfigurationError

Result = TypeVar("Result")


def parse_tls_verification(raw_value: bool | str) -> bool | str:
...
def integration_status() -> dict[str, Any]:
    ...
    try:
        build_client_config()
        configured = bool(settings.TEAMCENTER_ENABLED and settings.TEAMCENTER_BASE_URL)
